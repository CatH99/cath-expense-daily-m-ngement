<?php
include('session.php');
$exp_fetched = mysqli_query($conn, "SELECT * FROM expense WHERE ID = '$username'");
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6">
                        <table class="table table-hover table-bordered">
                            ...
                            while ($row = mysqli_fetch_array($exp_fetched)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['expensevalue'] . " VND"; ?></td>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            // print_r($resultspent);
                            //print_r($resultearn);
                            while ($rowspent = mysqli_fetch_array($resultspent) and $rowearn = mysqli_fetch_array($resultearn)) { ?>
                                <tr>
                                    <td><?php echo $rowearn['SUM(expensevalue)']." VND"; ?></td>
                                    <td><?php echo $rowspent['SUM(expensevalue)']." VND"; ?></td>
                                    <td><?php echo $rowearn['SUM(expensevalue)'] -$rowspent['SUM(expensevalue)']." VND";?></td>
                                </tr>
                            <?php
                            } ?>
                        </table>
